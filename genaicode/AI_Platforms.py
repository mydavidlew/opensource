...
def submain():
    # builds the sidebar menu
    with st.sidebar:
        st.page_link('AI_Platforms.py', label='Main Application', icon='🏠')
        st.page_link('pages/1RAG_Single.py', label='RAG-Single', icon='🌸️')
        st.page_link('pages/2RAG_Multiple.py', label='RAG-Multiple', icon='🌾')
